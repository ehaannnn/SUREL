...
class Yelp():
    def __init__(self):
        ...
        self.split_edge = {'train': {'edge': torch.Tensor(user2item_edge_index_train[:,126420:])},
        'valid': {'edge': torch.Tensor(user2item_edge_index_train[:,:126420]),
                 'edge_neg': torch.Tensor(user2item_edge_index_train[:,:63210])},
        'test': {'edge': torch.Tensor(user2item_edge_index_test[:,:23390]),
                'edge_neg': torch.Tensor(user2item_edge_index_test[:,23390:])}}
